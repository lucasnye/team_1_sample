...
class VirtualsACP:
    ...
    def browse_agents(self, keyword: str, cluster: Optional[str] = None, sortBy: Optional[List[ACPAgentSort]] = None, rerank: Optional[bool] = False, top_k: Optional[int] = None) -> List[IACPAgent]:
